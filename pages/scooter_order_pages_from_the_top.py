...
from Sprint_6.locators.scooter_order_locators import (cookie_consent_button,
                                                      upper_order_button, order_for_whom_header, input_name,
                                                      input_surname, input_address, input_subway_name,
                                                      subway_dropdown_option_template,
                                                      input_phone_number, next_button, order_about_rent_header,
                                                      input_date, current_date, input_term, dropdown_option_1,
                                                      checkbox_black, input_comment)
...
class OrderPage:
    ...
    def click_upper_order_button(self):
        self.browser.find_element(By.XPATH, upper_order_button).click()
    ...
    def fill_rent_info(self):
        ...
        WebDriverWait(self.browser, 10).until(
            expected_conditions.element_to_be_clickable((By.XPATH, dropdown_option_1))
        ).click()
        WebDriverWait(self.browser, 10).until(
            expected_conditions.element_to_be_clickable((By.XPATH, checkbox_black))
        ).click()
        self.browser.find_element(By.XPATH, input_comment).send_keys('Test')
